...
| 5 | 5.4 — Share / copy sprint info | pending | NEW |
...
| 6 | 6.5 — Privacy policy page scaffold | pending | NEW |
| 7 | 7.1 — Loading states and error boundaries | pending | |
| 7 | 7.2 — Responsive design pass | pending | |
| 7 | 7.3 — Accessibility pass | pending | NEW |
| 7 | 7.4 — Lighthouse audit and fixes | pending | Renumbered (was 7.3) |
| 7 | 7.5 — 404 page | pending | Renumbered (was 7.4) |
